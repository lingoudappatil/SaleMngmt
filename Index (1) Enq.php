...
<div class="topbar">
    ...
    $query = "SELECT id, parenq,custid, parenqdate,ccategory FROM db_enq"; // Remove the WHERE clause
    ...
    echo "<h1>Custmer Enquiry Details</h1>";
    echo "<table border='1'>";
    echo "<tr><th>Enq ID</th><th>Parent Enq</th><th>Category</th><th>Customer Id</th><th>Enq date</th></tr>";
