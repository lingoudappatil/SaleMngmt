...
<div class="topbar">
    ...
    $query = "SELECT id, oano,custid, oadate,ccategory FROM db_oa"; // Remove the WHERE clause
    ...
    echo "<h1>Custmer OA Details</h1>";
    echo "<table border='1'>";
    echo "<tr><th>OA ID</th><th>OA NO</th><th>Category</th><th>Customer Id</th><th>OA date</th></tr>";
